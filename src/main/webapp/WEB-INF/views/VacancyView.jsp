...
<html>
	...
	<body>
		...
		<p align="center"><a href="VacancyCreate" class="create-button">
			<spring:message code="vacancy.create"/></a></p>
		...
		<table border="1">
			<tr>
				<th>
					<spring:message code="vacancy.position"/>
					<a href="SortPosition" class="filter-sort-item">↓</a>
				</th>
				<th>
					<spring:message code="vacancy.salaryFrom"/>
					<a href="SortSalaryFrom" class="filter-sort-item">↓</a>
				</th>
				<th>
					<spring:message code="vacancy.salaryTo"/>
					<a href="SortSalaryTo" class="filter-sort-item">↓</a>
				</th>
				<th>
					<spring:message code="vacancy.experience"/>
